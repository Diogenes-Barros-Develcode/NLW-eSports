              ...
              <Dialog.Title className='text-3xl font-black'>
                ...
                <form className='mt-8 flex flex-col gap-4' onSubmit={handleCreateAd}>
                  <div className='flex flex-col gap-2'>
                    ...
                    <select id='game' className='bg-zinc-900 py-3 px-4 rounded text-small placeholder:text-zinc-500 appearance-none' defaultValue=''>
                  ...
                  <div className='mt-2 flex items-center gap gap-2 text-sm'>
                    <Checkbox.Root
